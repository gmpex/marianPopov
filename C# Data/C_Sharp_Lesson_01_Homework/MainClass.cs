...
namespace C_Sharp_Lesson_01_Homework
{
    public class MainClass
    {
        public static void Main(String[] args)
        {
            ...
            table.BottomSide();
            //------------------------
            /*Employee MARIAN_POPOV = new Employee("Marian Popov", 12.5, new DateTime(2020, 5, 20));
            Employee employee = null;
            IEmployeeOperations operations = new EmployeeOperations();
            operations.SalaryCalculator(20, MARIAN_POPOV.rate);*/
    }
    }
}
